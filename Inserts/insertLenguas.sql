...
--Regiones
NSERT INTO regiones (nombre_region) VALUES
    ('Sierra Norte'),
    ('Valles Centrales'),
   ('Sierra Mazateca'),
    ('Sierra Sur'),
...
--Comunidades 
NSERT INTO comunidades (nombre_comunidad, id_region) VALUES
...
--Lenguas
NSERT INTO lenguas (nombre_lengua, id_familia, id_region, numero_hablantes) VALUES
